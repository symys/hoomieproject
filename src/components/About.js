...
function About() {
  return (
    <div id='about' className="bg-light2 h-full text-dark1 font-montserrat flex lg:flex-row flex-col lg:pl-32 pl-16 pt-[2em] lg:pr-0 pr-4 pb-[10em] items-center">
       <div className="flex flex-col items-center basis-1/2">
        <div className="lg:text-7xl text-3xl font-bakbak self-start">About Us</div>
