...
function Navbar() {
  return (
    <div className='flex lg:flex-row gap-[21em] font-bakbak tracking-wider text-dark1 bg-light2 pt-4 items-center justify-center'>
      <div className='text-4xl hover:scale-110 duration-500 cursor-pointer '>Hoomie</div>
