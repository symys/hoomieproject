...
function OrderPage() {
  ...
  const deliveryPart =  <div className=" min-w-[65vw] h-auto p-10 bg-white rounded-[1em] shadow-2xl">
  <form
  ...
  return (
    <div className="font-montserrat items-center flex flex-col justify-center bg-light1 gap-1 pt-[8em] pb-[2em] lg:h-screen">
      <div className="gap-2 flex sm:flex-row flex-col bg-light3 p-2 rounded-[1em]">
        <button onClick={() => setToggle(true)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold lg:py-3 py-2 lg:px-[2.5em] px-8 rounded lg:text-xl text-sm tracking-widest">
          Delivery Address
        </button>
        <button onClick={() => setToggle(false)} className="hover:bg-blue-500 hover:text-white border-2 font-bold lg:py-3 py-2 lg:px-[2.5em] px-8 rounded lg:text-xl text-sm tracking-widest">
          Payment Method
        </button>
      </div>
